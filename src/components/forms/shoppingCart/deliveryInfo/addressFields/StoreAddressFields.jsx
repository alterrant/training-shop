...
const StoreAddressFields = ({formik}) => {
  ...
  return (
      <>
        ...
        <div className={DeliveryInfoFormStyle.formControl}>
          <label>
            <Field name='storeAddress' component={CustomStoreAddressInput} type='text'
                   initPlaceholder='Store address' availableStoreAddresses={availableStoreAddresses}
                   validate={(e) => deliveryInfoFieldsValidators.storeAddressValidator(e, availableStoreAddresses, formik.values.storeCountry)}/>
          </label>
