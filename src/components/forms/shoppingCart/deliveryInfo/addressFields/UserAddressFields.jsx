  ...
  return (
      <>
        <div className={DeliveryInfoFormStyle.formControl}>
          <label>
            <p>ADDRESS</p>
            <Field type='text' name='country' placeholder='Country' validate={deliveryInfoFieldsValidators.requiredValidator}
        ...
        <div className={DeliveryInfoFormStyle.formControl}>
          <Field type='text' name='city' placeholder='City' validate={deliveryInfoFieldsValidators.requiredValidator}
        ...
        <div className={DeliveryInfoFormStyle.formControl}>
          <Field type='text' name='street' placeholder='Street' validate={deliveryInfoFieldsValidators.requiredValidator}
        ...
        <div className={DeliveryInfoFormStyle.formControl}>
          <div className={DeliveryInfoFormStyle.house}>
            <Field type='text' name='house' placeholder='House' validate={deliveryInfoFieldsValidators.requiredValidator}
